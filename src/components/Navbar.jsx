                    ...
                    <ul className=' self-start text-right items-center'>
                        ...
                        <li className=''>
                            <NavLink to='/saloon' onClick={()=>setIsOpen(!isOpen)} className='text-lg my-10 text-white font-medium flex justify-center'>
                                <img src="https://img.icons8.com/ios-filled/25/ffffff/barbershop.png" className='mr-5' /> 
                                Saloon
                            </NavLink>
                        </li>
                        <li className=''>
                            <NavLink to='/weddings' onClick={()=>setIsOpen(!isOpen)} className='text-lg my-10 text-white font-medium flex justify-center'>
                                <img src="https://img.icons8.com/ios/25/ffffff/newlyweds.png" className='mr-5' /> 
                                Weddings
                            </NavLink>
                        </li>
                        <li className=''>
